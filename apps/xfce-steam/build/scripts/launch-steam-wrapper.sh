...
#
# This is purely a local check-and-exec: no network call, no update
# trigger, nothing. It only routes to the patched script once one already
# exists on disk (i.e. after you've run enter-the-wired/Headcrab yourself
# at least once); until then it's identical to plain unpatched Steam.
